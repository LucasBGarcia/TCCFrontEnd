...
function ImprimiOS(informacoes) {
    ...
    const docConfig = {
        ...
        content: [
            ...
            { text: `Cliente: ${informacoes.client.name}`, style: 'esquerda' },
            { text: `Número: (53)${informacoes.client.number}`, style: 'esquerda' },
            { text: `Previsão de retirada: ${dataEntradaFormatada(informacoes.withdrawal)}`, style: 'esquerda' },
            { text: '================================================', style: 'centralizado' },
            { text: `Marca: ${informacoes.DeviceModel.DeviceBrand.devicebrand}      Modelo:${informacoes.DeviceModel.devicemodel}`, style: 'centralizado' },
            { text: `Serviço: ${informacoes.service.service}`, style: 'centralizado' },
            { text: `Observações: ${informacoes.observation}`, style: 'centralizado' },
            { text: `Valor: R$${Number(informacoes.value).toFixed(2)}`, style: 'centralizado' },
            { text: '================================================', style: 'centralizado' },
