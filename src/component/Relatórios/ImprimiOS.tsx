...
function ImprimiOS(informacoes) {
    ...
    const docConfig = {
        ...
        content: [
            ...
            { text: '(53)981353176', style: 'centralizado' },
            ...
            { text: `Número: ${informacoes.client.number}`, style: 'esquerda' },
            { text: `Data Saida: ${dataEntradaFormatada(informacoes.withdrawal)}`, style: 'esquerda' },
            { text: '================================================', style: 'centralizado' },
