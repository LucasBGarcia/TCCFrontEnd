...
const CalculaTotalFechadoHojeStone = () => {
    ...
    var functionSeparaPositivo = list.map(function (data: any) {
        if (data.pagamento.machine_id === 1) {
    ...
    return (
        <Box>
            <Text>Total Stone: {total.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' })}</Text>
        </Box>
    )


}
export default CalculaTotalFechadoHojeStone;
