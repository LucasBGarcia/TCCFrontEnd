...
const CalculaTotalFechadoHojeDinheiro = () => {
    ...
    var functionSeparaPositivo = list.map(function (data: any) {
        if (data.pagamento.PaymentMethod_id === 4) {
    ...
    return (
        <Box>
            <Text>Total dinheiro: {total.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' })}</Text>
        </Box>
    )


}
export default CalculaTotalFechadoHojeDinheiro;
