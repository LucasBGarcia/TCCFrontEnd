...
const CalculaTotalFechadoHojeBanriCompras = () => {
    ...
    var functionSeparaPositivo = list.map(function (data: any) {
        if (data.pagamento.machine_id === 3) {
    ...
    return (
        <Box>
            <Text>Total BanriCompras: {total.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' })}</Text>
        </Box>
    )


}
export default CalculaTotalFechadoHojeBanriCompras;
